...
-- Ajouter les colonnes pour les transactions récurrentes
...
ADD COLUMN logo VARCHAR(20) NULL COMMENT 'Emoji/icône pour identifier visuellement la transaction récurrente';
